...
import ru.smirnov.musicplatform.service.deprecated.sql.relation.CoArtistServiceOld;
...
@Service
public class TrackServiceOld {

    private final TrackRepository trackRepository;
    private final TrackMapperOld trackMapper;

    private final MinioService minioService;
    private final CoArtistServiceOld coArtistService;
    ...
    @Autowired
    public TrackServiceOld(
            TrackRepository trackRepository,
            TrackMapperOld trackMapper,
            ...
            CoArtistServiceOld coArtistService,
